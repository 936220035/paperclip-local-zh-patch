...
- `0004-expanded-zh-localizer-coverage.patch`
  - 必选补丁。
  - 扩展本地汉化层，补齐更多全局固定文案、输入框提示词、看板状态、最近活动、无项目、关联工作等界面文字。

- `0005-broader-zh-localizer-coverage.patch`
  - 必选补丁。
  - 继续扩展本地汉化层，补齐时间线、公司切换菜单、成本页、活动流水、公司设置页等更多显示文案。
